...
- [The Story: How the Source Code Leaked](#the-story-how-the-source-code-leaked)
- [Full Breakdown of Code Findings](#full-breakdown-of-code-findings)
...
### 1. The Terminal is a React App
Perhaps the most surprising finding is that the entire CLI is built using **React and Ink**. Instead of traditional stdout printing, Claude Code functions identically to a modern React web app with hooks, contexts, and over 140 UI components—all rendering directly into the terminal interface using chalk for styling. 

### 2. Bun Runtime & Dead Code Elimination
...
### 3. Agent Swarms and Multi-Agent Architecture
...
### 4. Comprehensive Tool & Command Ecosystem
...
| **Runtime Architecture** | [Bun](https://bun.sh) |
| **Terminal UI Framework** | [React](https://react.dev) + [Ink](https://github.com/vadimdemedes/ink) |
| **Code Scale** | ~1,900 files · 512,000+ lines of codebase |
