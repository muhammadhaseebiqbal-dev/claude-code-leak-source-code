...
*Note: Since the original application was acquired via a `.map` artifact, unit tests for these tools and external configuration models (internal dependency JSON files, test scaffolds) are missing.*
